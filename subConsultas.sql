...
# ver el precio de un libro y compararlo con el libro mas caro
...
drop table if exists libros;
 ...
 select codigoeditorial from libros where autor='Richard Bach'; # me da el codigo, y cuando son muchos, se hace complicado
 ...
 insert into libros(titulo,autor,codigoeditorial,precio) values('Cervantes y el quijote','Borges',3,25);
  ...
  # Selecciona titulos de libros de BORGES de editoriales que han publicado a Richard Bach
 ...
 # no se cumple que todas las editoriales hayan publicado de Borges
 select titulo from libros where autor='Borges' and codigoeditorial = all
 (select e.codigo from editoriales as e join libros as l on codigoeditorial=e.codigo where l.autor='Richard Bach');
 
 select titulo, precio from libros where autor='Borges' and precio > some # some and any me dan el mismo resultado
