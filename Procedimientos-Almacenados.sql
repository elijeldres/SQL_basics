CREATE DATABASE IF NOT EXISTS procedimientosalmacenados; # Stored Procedures
...
# cuales son los libros en stock que le quedan menos de 10
delimiter //
create procedure pa_libros_stock() #pa = procedimiento_almacenado
begin
...
# que libros tiene un autor autor determinado, preguntar finalmente por Richard Bach
...
call pa_libros_autor('Gabriela Mistral'); 
...
call pa_autor_totalypromedio('Richard Bach', @sumatotal, @promedio); # nos da el titulo, editorial y precio de los libros del autor consultado
# @sumatotal , @promedio tomaran los resultados de los parametros 

select @sumatotal, @promedio; # da el resultado a la pregunta cual es la suma y el promedio de los libros de Richard Bach
