...
# otra sintaxis para crear  vista
...
#/*Vistas actualizables (insert-update)*/ hay que tener en cuenta que al actualizar los datos en una lista, se actualizan los datos de su tabla base
...
drop table if exists profesores;
 ...
 # se inserta en la lista de alumnos aprobados, pero no cumple con la condicion, sin embargo el dato se integra a la tabla  alumnos. 
  insert into vista_nota_alumnos_aprodabos(documento, nombrealumno, nota, codigoprofesor)
